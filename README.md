...
|2-2| 시장에 방문했는데 가고싶은 가게가 휴무이거나, 가격이 변동된 경우가 있었나요? 그때 어떤 상황이었는지 설명해주세요.|시장 정보 변동 확인|
...
이는 악순환이 되어 전통시장을 먹거리 위주의 단순한 장소로 만들어 웰니스에 악영향을 미치고 있었습니다.

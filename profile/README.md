...
|핵심 가치|비전|미션|
|:--:|:--:|:--:|
|기술을 통해 전통시장 경험을 혁신한다.|사용자가 자신의 감정을 이해할 수 있게 한다.|사용자가 자신을 이해하고 이를 삶에 적용할 수 있게 한다.|
<br />
- - -
...
|기능 이름|액션|내용|
| --- | --- | --- |
| 시럽 포인트 | 초기 유동성 확보 |수수료 0%를 달성하기 위해 필요한 초기 유동성 확보 수단, 유저는 시럽 포인트를 현금으로 구매하고 할인된 가격으로 가게 이용 가능|
| 럽키트 | 시장 상인 콜라보 |SNS에서 유명한 시장 맛집을 가보고 싶지만, 시공간적 제약으로 그러지 못하는 사람들을 위해 밀키트를 PB상품으로 판매|
